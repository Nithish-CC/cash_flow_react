...
import { feesDetailsAutosearch, feesDetailsLastFourRecord } from "../constants/action-types";
...
export const feesDetailsLastFourRecordData = (status, year) => async (dispatch) => {
    try {
