...
import { listOfPaymentstudentAllPayBalance, listOfPaymentStudentYearPost } from "../constants/action-types";
...
export const listOfPaymentstudentAllPayBalanceData = (id, academicYearId) => async (dispatch) => {
    try {
        getAccessToken();
