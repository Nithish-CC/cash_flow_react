...
import { listOfPaymentstudentAllPayBalanceData, listOfPaymentStudentYearPostData } from "../../redux/actions/listOfPaymentRed";
...
const Listofpayment = (props: any) => {
    ...
    const studentyearpostdata = useSelector((state: any) => state.studentDetailsGet.listOfPayment_StudentYearPost?.data?.data);
    useEffect(() => {
    ...
    const studentallpaybalancedata = useSelector((state: any) => state.studentDetailsGet.listOfPayment_studentAllPayBalance?.data?.data);
    ...
    function studentyear(gradedata: any) {
        var matchedyearid: any = props.feemasterid && props.feemasterid.length && props.feemasterid.filter((data: any) => data.fee_master_id === gradedata.fee_master_id);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <Form.Select
                                                            ...
                                                            id="academic_year"
                                                            onChange={(e: any) => setAcademicYearId(e.target.value)}
                                                        >
                                                            {academicyear &&
                                                                academicyear.length &&
