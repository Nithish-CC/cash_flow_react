...
const Feesdetails = (props: any) => {
    ...
    useEffect(() => {
        ...
        lastFourRecord && lastFourRecord.length &&
    ...
    function FeeMaster(feemasterdata: any) {
        ...
        matchedyearid && matchedyearid.length && matchedyearid.forEach((element: any) => {
            GetId.push(element);
        });
                                    ...
                                    <div>
                                        <label>
                                            {lastFourRecord &&
                                                ...
                                                lastFourRecord.map((data: any) => {
                                                    return <option> {data.date_of_transcation.trim()}</option>;
                                                })}
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <label>
                                            {allGotFinalData &&
                                                allGotFinalData.length &&
                                                allGotFinalData.map((amount: any) => {
                                                    return <option> {(amount = amount.Allbalance)}</option>;
                                                })}{" "}
                                        </label>
                                    </div>
                                </div>
