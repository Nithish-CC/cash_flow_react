...
import { feesDetailsAutosearchData, feesDetailsLastFourRecordData } from "../../redux/actions/feesDetail";
...
const Feesdetails = (props: any) => {
    ...
    const feesdetailsautosearch = useSelector((state: any) => state.studentDetailsGet.feesDetails_autoSearch);

    const feesdetailslastfourrecord = useSelector((state: any) => state.studentDetailsGet.feesDetails_lastFourRecords);
    console.log(feesdetailslastfourrecord);

    const setfeemasterdata = useSelector((state: any) => state.studentDetailsGet.feesDetails_SetFeeMasterId);
                ...
                <div className="col-lg-6">
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            <div className="row">
                                {feesdetailslastfourrecord && feesdetailslastfourrecord.length > 0 ? (
                                    <>
