...
import { studentDetailsPost, studentProfileSearchWithIdData, stuProfileSearchSetAllSection } from "../../redux/actions/studentProfileSearchActions";
...
const StudentprofileSearch = () => {
    ...
    const studentProfile = useSelector((state: any) => state.studentDetailsGet.studentProfile?.data?.data);
    ...
    const studentdetailsgetdata = useSelector((state: any) => state.studentDetailsGet.studentProfile_gradeSection);
    ...
    function SectionId(Sectiondata: any) {
        var matchedyearid: any = studentdetailsgetdata && studentdetailsgetdata.length && studentdetailsgetdata.filter((data: any) => data.grade_id === Sectiondata);
    ...
    const studentprofilewithid = useSelector((state: any) => state.studentDetailsGet.studentProfileSearch_edit?.data);
    ...
    const searchedit = () => {
        if (statusStudentDetails.alt_phone_number.toString().match(mobileNoPattern) === statusStudentDetails.phone_number.toString().match(mobileNoPattern)) {
                                ...
                                {statusStudentSearch ? (
                                    <div>
                                                            ...
                                                            <h4 className="m-0 text-danger">
                                                                ...
                                                                {!statusStudentEdit ? (
                                                                    <i
                                                                        ...
                                                                        onClick={() => {
                                                                            setUpdateProfileActive(statusStudentDetails.status);
                                                                            setSectionFilter(statusStudentDetails.grade_section_id);
                                                                    ...
                                                                    {!statusStudentEdit ? (
                                                                        ...
                                                                        <Form.Select name="grade_section_id" size="sm" value={sectionFilter} onChange={(e: any) => setSectionFilter(e.target.value)}>
                                                                            {FinalSectionIdData &&
                                                                                ...
                                                                                FinalSectionIdData.map((values: any, i: any) => {
                                                            ...
                                                            <Form.Group as={Row}>
                                                                ...
                                                                >
                                                                    {!statusStudentEdit ? (
                                                                        ...
                                                                        <Form.Control onChange={handleChange} type="text" name="admission_no" value={statusStudentDetails.admission_no} size="sm" />
                                                                    )}
                                                                </Col>
                                                            </Form.Group>
                                                        </div>
                                                                ...
                                                                >
                                                                    {!statusStudentEdit ? (
                                                                        ...
                                                                        <div onChange={handleChange} key={`inline-radio`} className="mb-3">
                                                                            <Form.Check
                                                                                inline
                                                                                checked={UpdateProfileActive === "Active" ? true : false}
                                                                                label="Active"
                                                                                name="status"
                                                                                type="radio"
                                                                                id={`inline-radio-1`}
                                                                            ...
                                                                            <Form.Check
                                                                                inline
                                                                                checked={UpdateProfileActive === "Inactive" ? true : false}
                                                                                label="Inactive"
                                                                                name="status"
                                                                                type="radio"
                                                                                id={`inline-radio-2`}
                                        ...
                                        <Hostel
                                            ...
                                            Student_status={statusStudentDetails.status}
                                        ></Hostel>
                                        <Academicfees studentDetails={statusStudentDetails}></Academicfees>
                                    </div>
                                ) : (
