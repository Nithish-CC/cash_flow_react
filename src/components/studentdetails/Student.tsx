...
import { Row, Col, Form, Button, Spinner,FormGroup } from "react-bootstrap";
...
const Student = () => {
    ...
    const searchData = () => {
        setLoader(true);
        if (statusStudentSearch == "") {
            setStatusStudentDetails({ error: true });
        } else {
            axios
                .get(`https://61ea85bfc9d96b0017700bb9.mockapi.io/search/${inputValue}`)
    ...
    const searchedit = () => {
        axios
            .put(`https://61ea85bfc9d96b0017700bb9.mockapi.io/search/${statusStudentDetails.student_admissions_id}`, {
    ...
    const fetchData = () => {
        setLoader(true);
            return  axios.get(`https://61ea85bfc9d96b0017700bb9.mockapi.io/search/${inputValue}`)
                .then((response: AxiosResponse) => {
                          ...
                          <div>
                            {suggestions.map((item: any) => (
                              <div key={statusStudentDetails.student_admissions_id}>
                                ...
                                {loader == false &&
                                !statusStudentSearch &&
                                statusStudentDetails &&
                                Object.keys(statusStudentDetails).length > 0 ? (
                                    <div>
                                        <Form>
                                            <div className="row">
                                    ...
                                    <>
                                        ...
                                        {loader == true &&
                                            statusStudentDetails &&
                                            statusStudentDetails.error == true && (
