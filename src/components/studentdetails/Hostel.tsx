...
import { hostalFeeValueData, hostalModeOfTransportData, modeOfTransports } from "../../redux/actions/modeOfTransport";
                        ...
                        <div className="card-body">
                            <div>
                                <Row>
                                    <Col>
                                        <div>
                                            <input name="radio-item-1" type="radio" value="Self" onChange={(e) => setCurrentValue(e.target.value)} checked={currentRadioValue === "Self"} />
                                            <Form.Label>Self</Form.Label>
                                        </div>
                                    </Col>
                                    <Col>
                                        <div>
                                            <input name="radio-item-1" value="Transport" type="radio" onChange={(e) => setCurrentValue(e.target.value)} checked={currentRadioValue === "Transport"} />
                                    ...
                                    <Col>
                                        <div>
                                            <input name="radio-item-1" value="Hostal" type="radio" onChange={(e) => setCurrentValue(e.target.value)} checked={currentRadioValue === "Hostal"} />
                                ...
                                <Modal show={show} onHide={() => setShow(!show)}>
                                    ...
                                    <Modal.Body>Are You Sure You Want To Submit {currentRadioValue} ?</Modal.Body>
                                    <Modal.Footer>
