  ...
  const handleSubmit = (e: any) => {
    ...
    if (
      ...
      if (admissionNo.length <= 0) {
        ...
        toastify("Student Name");
      } else if (fromGrade.length <= 0) {
        toastify("From Grade");
        ...
        toastify("Section");
      } else if (previousSchoolInfo.length <= 0) {
        toastify(" Previvous School Info");
      } else if (fatherName.length <= 0) {
        toastify("Father Name");
      } else if (fatherOccupation.length <= 0) {
        toastify("Father Occupation");
                            ...
                            <div className="col-md-6">
                              <InputGroup hasValidation>
                                <Form.Control
                                  ...
                                  onChange={(e) =>
                                    setAdmissionno(String(e.target.value))
                                  }
                                />
                          ...
                          >
                            ...
                            <div className="col-md-6">
                              <InputGroup hasValidation>
                                <Form.Control
                                  type="date"
                                  value={moment(admissionDate).format(
                                    "YYYY-MM-DD"
                                  )}
                                  onChange={(e) =>
                                ...
                                >
                                  {sectionBasedOnGrade &&
                                    ...
                                    sectionBasedOnGrade.map((values: any) => {
                                      return (
                                        <option value={values.grade_section_id}>
                                          {" "}
                                          {values.section}
                                        </option>
                                      );
                          ...
                          >
                            ...
                            <div className="col-md-6">
                              <InputGroup hasValidation>
                                ...
                                />
                                <Form.Control.Feedback type="invalid">
                                  Please Enter Previous School Info
                                </Form.Control.Feedback>
                              </InputGroup>
                            </div>
                          </Form.Group>
